...
class IntegerRandomizationStrategy(MutationStrategy):
    ...
    def apply(self, context: MutationContext) -> MutationContext:
        ...
        return MutationContext(
            key_paths=context.key_paths, original_value=random_value, original_type=int
        )
...
class StringRandomizationStrategy(MutationStrategy):
    ...
    def apply(self, context: MutationContext) -> MutationContext:
        ...
        return MutationContext(
            key_paths=context.key_paths, original_value=random_value, original_type=str
        )
...
class BooleanRandomizationStrategy(MutationStrategy):
    ...
    def apply(self, context: MutationContext) -> MutationContext:
        ...
        return MutationContext(
            key_paths=context.key_paths, original_value=random_value, original_type=bool
        )
...
class ListRandomizationStrategy(MutationStrategy):
    ...
    def apply(self, context: MutationContext) -> MutationContext:
        random_value = [
            random.choice(context.original_value) for _ in context.original_value
        ]
        logger.debug(
        ...
        return MutationContext(
            key_paths=context.key_paths, original_value=random_value, original_type=list
        )
...
class DictRandomizationStrategy(MutationStrategy):
    ...
    def apply(self, context: MutationContext) -> MutationContext:
        ...
        return MutationContext(
            key_paths=context.key_paths, original_value=random_value, original_type=dict
        )
